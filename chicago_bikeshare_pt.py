...
print("Linha 0: ", data_list[0])
# É o cabeçalho dos dados, para que possamos identificar as colunas.

# Imprimindo a segunda linha de data_list, ela deveria conter alguns dados
print("Linha 1: ", data_list[1])
...
for line_enume in data_list[:20]:
    print(line_enume[-2])
...
# Median trip:
sorted_list = sorted(float(i_count) for i_count in trip_duration_list)
